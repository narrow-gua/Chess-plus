...
public class TileEntityCChessPVPRenderer  implements BlockEntityRenderer<TileEntityCChessPVP> {
    ...
    public TileEntityCChessPVPRenderer(BlockEntityRendererProvider.Context context) {
    ...
    private void renderTipsText(TileEntityCChessPVP chess, PoseStack poseStack, MultiBufferSource bufferIn, int combinedLightIn) {
    ...
    private void renderPiece(TileEntityCChessPVP cchess, PoseStack poseStack, MultiBufferSource bufferIn, int combinedLightIn, int combinedOverlayIn, Direction facing) {
    ...
    private boolean inRenderDistance(TileEntityCChessPVP chess, int distance) {
    ...
    @Override
    public boolean shouldRenderOffScreen(TileEntityCChessPVP te) {
        return true;
    }
}
